...
void setup() { //Start setup ======================================================================================
  ...
  //Star
    for (int starsOrder = 0; starsOrder < 50; starsOrder = starsOrder + 1) {
      starsLeftSideX[starsOrder] = random(10, 100);
      starsLeftSideY[starsOrder] = random(500);
      starsRightSideX[starsOrder] = random(500 - 100, 500 - 10);
      starsLeftSideY[starsOrder] = random(500);
      speedStars[starsOrder] = random(1, 3);
    }
